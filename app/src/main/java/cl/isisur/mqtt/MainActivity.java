...
public class MainActivity extends AppCompatActivity {
    ...
    static String MQTTHOST = "tcp://192.168.43.81:1883    ";
    static String USERNAME = "C";
    static String PASSWROD = "Cristobal2431.";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MqttAndroidClient client =
                new MqttAndroidClient(this.getApplicationContext(), "tcp://192.168.43.81:1883",
                        clientId);
        try {
            ...
            token.setActionCallback(new IMqttActionListener() {
                ...
                public void onSuccess(IMqttToken asyncActionToken) {
                    Toast toast =
                            Toast .makeText(getApplicationContext(),"Conexion correta",Toast.LENGTH_SHORT);
                    toast.show();
                }
                @Override
